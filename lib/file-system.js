...
var identity = (function identity$(a) {
  /* identity src/file-system.sibilant:38:0 */
...
var onceThen = (function onceThen$(event, emitter) {
  /* once-then src/file-system.sibilant:60:0 */
...
is.empty__QUERY = (function is$empty__QUERY$(value) {
  /* is.empty? src/file-system.sibilant:67:0 */

  return 0 === value.length;
});
var athrow = (function athrow$(errType, message) {
  /* athrow src/file-system.sibilant:70:0 */
...
var getValueOf = (function getValueOf$(o) {
  /* get-value-of src/file-system.sibilant:73:0 */
...
var plift = (function plift$(f) {
  /* plift src/file-system.sibilant:173:0 */
...
var fillSubDir = (function fillSubDir$(p_subPath$1, seg) {
  /* fill-sub-dir src/file-system.sibilant:184:0 */
...
var isDir = (function isDir$(c) {
  /* is-dir src/file-system.sibilant:215:0 */
...
mixin({ 
  ...
  _discoverNode:R.curry((function(path, seq, _tree, fs, stats) {
    /* src/file-system.sibilant:211:28 */
